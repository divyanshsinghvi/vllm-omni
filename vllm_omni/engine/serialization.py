...
from vllm_omni.data_entry_keys import OmniPayloadStruct, deserialize_payload, serialize_payload
...
def serialize_additional_information(
    raw_info: dict[str, Any] | OmniPayloadStruct | AdditionalInformationPayload | None,
    *,
    ...
    ``OmniPayload`` TypedDict / ``OmniPayloadStruct`` structure.
    """
    if raw_info is None:
        return None

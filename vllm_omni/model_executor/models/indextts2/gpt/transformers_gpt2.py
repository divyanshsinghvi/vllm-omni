...
from vllm_omni.model_executor.models.indextts2.gpt.transformers_modeling_utils import PreTrainedModel
...
class GPT2FlashAttention2(GPT2Attention):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # TODO: Should be removed once Flash Attention for RoCm is
        # bumped to 2.1. flash_attn<2.1 generates top-left aligned
        # causal mask, while what is needed here is bottom-right
        # alignment, that was made default for flash_attn>=2.1.
        # This attribute is used to handle this difference.
        # Ref: https://github.com/Dao-AILab/flash-attention/releases/tag/v2.1.0
        # Beware that with flash_attn<2.1, using q_seqlen != k_seqlen
        # (except for q_seqlen == 1) produces a wrong mask (top-left).
...
class GPT2SdpaAttention(GPT2Attention):
    ...
    def forward(
        ...
        # via this `is_causal` if statement instead of an inline
        # conditional assignment in SDPA to support both
        # torch.compile's dynamic shapes and full graph options.
...
PARALLELIZE_DOCSTRING = r"""
    ...
    # using gpt2-xl, which has a total of 48 attention modules:
